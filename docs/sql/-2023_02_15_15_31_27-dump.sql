...
--
-- Host: 124.223.80.135    Database: smart_post
-- ------------------------------------------------------
...
INSERT INTO `comment` VALUES (1625757341879328769,1571562360907292674,1625757062769369090,1571562360907292674,'哈哈哈哈',0,0,NULL,0,NULL,'2023-02-15 07:22:11','2023-02-15 07:22:11',0),(1625758597523922945,1571562360907292674,1625757062769369090,1571562360907292674,'哈哈哈哈',0,0,NULL,2,NULL,'2023-02-15 07:27:10','2023-02-15 07:27:42',0),(1625758643199893505,1571562360907292674,1625757062769369090,1571562360907292674,'哈卡卡卡',0,1,1625758597523922945,2,NULL,'2023-02-15 07:27:21','2023-02-15 07:28:02',0),(1625758914642665473,1571562360907292674,1625757062769369090,1571562360907292674,'123123\n\n',0,0,NULL,0,NULL,'2023-02-15 07:28:26','2023-02-15 07:28:26',0);
...
INSERT INTO `post` VALUES (1625757062769369090,'后端','数据库',1571562360907292674,'测试数据库','<p>测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库</p>',0,0,1,0,4,1,'127.0.0.1','测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库测试数据库...','2023-02-15 07:28:26','2023-02-15 07:21:04',0);
...
CREATE TABLE `user_interact` (
  ...
  `is_thumb` tinyint(1) NOT NULL COMMENT '0 = false  1 = true',
  `is_comment` tinyint(1) NOT NULL COMMENT '0 = false  1 = true',
  `is_collect` tinyint(1) NOT NULL COMMENT '0 = false  1 = true',
...
INSERT INTO `user_interact` VALUES (1625757308647858177,1571562360907292674,0,1625757062769369090,1,1,0,'2023-02-15 15:22:03','2023-02-15 15:22:03'),(1625758644235886593,1571562360907292674,1,1625757062769369090,0,1,0,'2023-02-15 15:27:21','2023-02-15 15:27:21'),(1625758671599525890,1571562360907292674,2,1625758643199893505,0,0,0,'2023-02-15 15:27:28','2023-02-15 15:27:28'),(1625758728713363457,1571562360907292674,1,1625758597523922945,1,0,0,'2023-02-15 15:27:42','2023-02-15 15:27:42'),(1625758729363480577,1571562360907292674,1,1625758597523922945,1,0,0,'2023-02-15 15:27:42','2023-02-15 15:27:42');
...
INSERT INTO `xxl_job_group` VALUES (1,'smart-postEntity','文章信息执行器',0,'http://192.168.6.198:10001/,http://192.168.6.198:9999/','2022-08-30 02:16:29');
...
CREATE TABLE `t_notice_message_info` (
  ...
  `title` varchar(100) NOT NULL COMMENT '通知消息标题',
  `content` varchar(200) NOT NULL COMMENT '通知消息内容',
...
-- Dump completed on 2023-02-15 15:31:52
