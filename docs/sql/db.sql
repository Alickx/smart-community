...
INSERT INTO `user_profile` VALUES (1571562363390316546,1571562360907292673,'','','','','','',0,0,0,'','','','',0,'',0,0,'2022-09-18 18:10:40','','2022-09-18 18:10:40','2022-09-18 18:10:40');
...
CREATE TABLE `post` (
  ...
  KEY `post_status_is_publish_index` (`state`,`is_publish`)
...
-- Dump completed on 2022-09-19  9:01:36
