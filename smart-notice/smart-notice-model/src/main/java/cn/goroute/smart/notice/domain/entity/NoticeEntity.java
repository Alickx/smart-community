...
public class NoticeEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getMsgInfoId() == null ? other.getMsgInfoId() == null : this.getMsgInfoId().equals(other.getMsgInfoId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMsgInfoId() == null) ? 0 : getMsgInfoId().hashCode());
