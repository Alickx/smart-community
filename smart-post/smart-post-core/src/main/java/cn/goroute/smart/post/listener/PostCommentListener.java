...
@RocketMQMessageListener(
		...
		consumerGroup = RocketMqBizConstant.CommentMqConstant.COMMENT_HANDLE_GROUP,
...
public class PostCommentListener extends BaseMqMessageListener<RocketMqEntityMessage>
	...
	protected void handleMessage(RocketMqEntityMessage message) {
		SpringUtils.publishEvent(JsonUtils.toObj(message.getMessage(), CommentEntity.class));
	}
